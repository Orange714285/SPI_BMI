...
#include <cmath>
AccAttitudeAlgorithmer::AccAttitudeAlgorithmer(float bmi055_acc_x,float bmi055_acc_y,float bmi055_acc_z)
{
    ...
    m_imu_acc_x = m_FRD_gravity_vec[0];
    m_imu_acc_y = m_FRD_gravity_vec[1];
    m_imu_acc_z = m_FRD_gravity_vec[2];

    m_frd_acc_x = m_FRD_gravity_vec[0];
    m_frd_acc_y = m_FRD_gravity_vec[1];
    m_frd_acc_z = m_FRD_gravity_vec[2];
